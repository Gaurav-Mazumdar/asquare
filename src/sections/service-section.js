...
import TextFeature from 'components/service-feature';
...
import Edit from 'assets/services/Edit.svg';
    ...
    <section sx={{variant: 'section.services'}} id="services">
      <Container sx={styles.containerBox}>
        ...
        <Box sx={styles.contentBox}>
          <TextFeature subTitle={data.subTitle} title={data.title} category={data.category}/>
          <Grid sx={styles.grid}>
